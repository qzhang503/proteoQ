...
produced with usersâ selection of parameters in data filtration,
...
creating âwrappersâ around published R functions.

Installation
------------

To install this package, run R (version â3.6â) as *administrator*
...
*Process PSMs* â In this section, I demonstrate the summarisation of PSM
...
*Summarize PSMs to peptides* â We next summarise PSM to peptides.
...
Letâs compare the log2FC profiles with and without scaling
normalization:[4]
...
*Summarize peptides to proteins* â We then summarise peptides to
proteins.
...
Philipp, Martins. 2018. âReproducible Workflow for Multiplexed
Deep-Scale Proteome and Phosphoproteome Analysis of Tumor Tissues by
Liquid Chromatography-Mass Spectrometry.â *Nature Protocols* 13 (7):
1632â61. <https://doi.org/10.1038/s41596-018-0006-9>.
...
`scale_log2`, I donât recommend using it.
