# proteoQ
Process TMT data from tandem MS experiments (see `vignette.html` for more details)
...
![BI_GL1_N](https://github.com/qzhang503/proteoQ/blob/master/vignettes/Peptide/Histogram/Peptide_BI_GL1_N.png "Without scaling normalization"){ width=45% } ![BI_GL1_Z](https://github.com/qzhang503/proteoQ/blob/master/vignettes/Peptide/Histogram/Peptide_BI_GL1_Z.png "With scaling normalization"){ width=45% }
...
*Summarize peptides to proteins* --- We next illustrate our approach of summarising peptides to proteins.  
