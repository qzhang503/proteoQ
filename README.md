...
| pep\_istryptic        | Is a peptide sequence a canonical tryptic peptide or not                                                                                                                                  |                                                                                                                                                                                          |
...
| pep\_ivmod            | Variable Anywhere modificaiton of peptide as a string of hexcodes                                                                                                                         | Ordianl number of neutral lossin in square brackets for fixed modifications and in round parentheses for variable modifications. Terminal modifications are not indicated by the string. |
