...
![Mascot_export](images/mascot/mascot_export.png){ width=45% }
...
![Mascot_daemon](images/mascot/mascot_daemon.png){ width=45% } 
...
![Peptide_N](images\\peptide\\histogram\\peptide_bi_gl1_n.png){ width=45% } ![Peptide_Z](images\\peptide\\histogram\\peptide_bi_gl1_z.png){ width=45% }
...
![Peptide_MDS](images\\peptide\\mds\\peptide_mds.png){ width=45% } 
...
![Peptide_JHU_MDS](images\\peptide\\mds\\mds_jhu.png){ width=45% } ![Peptide_JHU_MDS_new_aes](images\\peptide\\mds\\mds_jhu_new_aes.png){ width=45% }
...
![Peptide_EucDist](images\\peptide\\mds\\eucdist_jhu.png){ width=45% }
...
![Peptide_Corr_PNNL](images\\peptide\\corrplot\\corr_pnnl.png){ width=45% } ![Protein_Corr_PNNL](images\\protein\\corrplot\\corr_pnnl.png){ width=45% }
...
![Protein_heatmap](images\\protein\\heatmap\\heatmap.png){ width=80% }
...
Batch effects:
  ![img_volcplot_batches](images\\protein\\volcplot\\batches.png){ width=80% }

![img_venn_batches](images\\protein\\volcplot\\venn_batches.png){ width=80% }

Location effects:
  ![img_volcplot_location](images\\protein\\volcplot\\locations.png){ width=80% }

![img_venn_location](images\\protein\\volcplot\\venn_locations.png){ width=80% }
...
![Protein_trends](images\\protein\\trend\\prn_trend_n6.png){ width=80% }
...
![Protein_NMF_consensus](images\\protein\\nmf\\prn_nmf_r6_consensus.png){ width=40% }
![Protein_NMF_coefficients](images\\protein\\nmf\\prn_nmf_r6_coef.png){ width=40% }
...
![Peptide_reference_effect_1](images\\peptide\\histogram\\peptide_ref_w2.png){ width=80% }
...
![Peptide_reference_effect_2](images\\peptide\\histogram\\peptide_ref_w2_w16.png){ width=80% }
...
![peptide_subset_hist](images\\peptide\\histogram\\bi_cmbn_peptides.png){ width=40% }
![peptide_subset_hist2](images\\peptide\\histogram\\bi_phospho_sub.png){ width=40% }
