...
The following link will render a [README.html](https://htmlpreview.github.io/?https://github.com/qzhang503/proteoQ/blob/master/README.html) with a floating TOC.  Note that the process might take a while.  
...
With the above example at `n_clust = 6`, the correspondence between protein IDs and their cluster assignments is summarised in file `Protein_Trend_Z_n6.csv`. The letter `Z` in the file name denotes the option of `scale_log2r = TRUE`.
