...
The results are reported at the levels of PSM, peptide and protein. The order of column keys will be slightly different between databases of `RefSeq` or `Uniprot`.  
