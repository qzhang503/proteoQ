...
img_pepEucDist <- "images\\peptide\\mds\\eucDist_pnnl.png"
...
![Intensity](images/protein/corrplot/protein_int_corr.png){ width=45% } ![log2FC](images/protein/corrplot/protein_log2fc_corr.png){ width=45% }
