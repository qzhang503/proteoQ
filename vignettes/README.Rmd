...
The data processing begins with PSM table(s) from [Mascot](https://proteoq.netlify.app/post/exporting-mascot-psms/), [MaxQuant, MSFragger](https://proteoq.netlify.app/post/interfaces-to-search-engines/), [Mzion](https://github.com/qzhang503/mzion) or Spectrum Mill with the following compilation in file names:
...
The corresponding PSMs are available through one of the followings `copy_` utilities (suggest go directly with real PSM outputs from a search engine):
