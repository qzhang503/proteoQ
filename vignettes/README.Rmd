...
```{r prnGSPAHM_example_1, echo=FALSE, fig.align='center', fig.cap="**Figure 7B.** Heat map visualization of the distances of gene sets", fig.show='hold', message=FALSE, warning=FALSE, out.width='80%'}
img_volcplot_gspahm <- "images\\protein\\gspa\\prn_gspa.png"
knitr::include_graphics(c(img_volcplot_gspahm))
```
