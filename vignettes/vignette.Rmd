...
\vspace{1.5cm}*Process PSMs* --- In this section, I demonstrate my approach of summarising PSM data to peptides and proteins. The data set that I use in this section corresponds to the proteomics data from Mertins et al.[-@mertins2018np]. We start by processing PSM data from `Mascot` outputs:  
...
The following shows an example of heat map visualization against protein data:
...
The following shows the imputation of peptide and protein data:
...
The following shows the trend analysis of protein expressions:
...
The following shows the NMF analysis of protein data:
...
The following shows the significance analysis of peptide and protein data:

```{r SigTest, eval = FALSE}
# Peptide significance tests
# Multiple terms and contrasts allowed 
pepSig(
	scale_log2r = TRUE, 
...
The following shows the volcano plot visualization of peptide and protein data:
...
The following maps gene sets for volcano plot visualization:
