...
<iframe width="560" height="315" src="https://www.youtube.com/embed/y0VuWLUpcek" frameborder="0" allowfullscreen></iframe>
...
### MDS and PCA plots
In this section, we visualize MDS, PCA and Euclidean distance against the peptide data at `scale_log2r = TRUE`. We start with metric MDS: 
...
img_pepmds <- "Peptide\\MDS\\Peptide_MDS.png"

knitr::include_graphics(c(img_pepmds))
```

It is clear that the WHIM2 and WHIM16 samples are well separated by Euclidean distance (**Figure 2A**). We next take the `JHU` data subset as an example to explore batch effects in the proteomic sample handling: 
