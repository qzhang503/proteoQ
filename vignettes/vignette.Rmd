...
```{r Protein_heatmap, echo=FALSE, fig.align='center', fig.cap="**Figure 4.** Heat map visualization of protein log2FC at `scale_log2r = TRUE`", fig.show='hold', message=FALSE, warning=FALSE, out.width='45%'}
...
```{r protein volcano plots, echo=FALSE, fig.align='center', fig.cap="**Figure 5A-5B.** Volcano plot visualization of log2FC. Left: contrasts defined in `contrasts_1`; right, contrasts defined in `contrasts_2`", fig.show='hold', message=FALSE, warning=FALSE, out.width='45%'}
img_volcplot_1 <- "images\\protein\\volcplot\\volcplot_l.png"
img_volcplot_2 <- "images\\protein\\volcplot\\volcplot_2.png"
knitr::include_graphics(c(img_volcplot_1, img_volcplot_2))
```
