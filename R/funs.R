...
# 
# $funs.R
# [1] "# [1] \"# [1] \\\"# [1] \\\\\\\"# [1] \\\\\\\\\\\\\\\"#  [2] \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"find_mascot_psmraws <-function(filelist = NULL, dat_dir = NULL)\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\"\\\\\\\\\\\\\\\"\\\\\\\"\\\"\""                          
# [2] "# [2] \"# [2] \\\"# [2] \\\\\\\"#  [1] \\\\\\\\\\\\\\\"extract_raws\\\\\\\\\\\\\\\"                                                    \\\\\\\\\\\\\\\"find_mascot_psmraws <-function(filelist = NULL, dat_dir = NULL)\\\\\\\\\\\\\\\"\\\\\\\"\\\"\""
# [3] "# [3] \"# [3] \\\"#  [2] \\\\\\\"find_mascot_psmraws <-function(filelist = NULL, dat_dir = NULL)\\\\\\\"\\\"\""                                                                                                                                      
# [4] "# [4] \"#  [2] \\\"find_mascot_psmraws <-function(filelist = NULL, dat_dir = NULL)\\\"\""                                                                                                                                                            
# [5] "#   [1] \"extract_raws\"                                                    \"find_mascot_psmraws <-function(filelist = NULL, dat_dir = NULL)\""                                                                                                     
# 
# $global.R
...
# [16] "calcLFQPepNums"        "calcLFQPepInts"        "spreadPepNums"         "aggrNumLCMS"           "pad_grp_samples"      
# [21] "rep_ls_groups"         "normPep"               "hpeptideMBR"           "peptideMBR"            "find_ms1filepath"     
# [26] "rm_2RToutliers"        "rm_nRToutliers"        "sep_mbrfiles"          "extract_mbry"          "find_mbr_int"         
# [31] "addMBRpeps"            "groupMZPepZ"           "med_summarise_keys"    "load_prior"            "fmt_num_cols"         
# [36] "mergePep"              "standPep"              "Pep2Prn"               "map_peps_prots"        "find_prot_family_rows"
# [41] "my_sum_n"              "calcLFQprnnums"        "calc_tmt_prnnums"      "pep_to_prn"            "assign_duppeps"       
# [46] "replace_by_rowone"     "impPepNA"              "find_mbr_ms1files"    
# 
# $prntable.R
# [1] "standPrn"
# 
...
#  [62] "my_tolower"                                                     
#  [63] "my_upper"                                                       
#  [64] "add_maxquant_pepseqmod"                                         
#  [65] "add_msfragger_pepseqmod"                                        
#  [66] "add_cols_at"                                                    
#  [67] "replace_cols_at"                                                
#  [68] "reloc_col"                                                      
#  [69] "reloc_col_after"                                                
#  [70] "reloc_col_after_last"                                           
#  [71] "reloc_col_after_first"                                          
#  [72] "reloc_col_before"                                               
#  [73] "reloc_col_before_last"                                          
#  [74] "reloc_col_before_first"                                         
#  [75] "find_preceding_colnm"                                           
#  [76] "order_psm_cols"                                                 
#  [77] "order_mascot_psm_cols"                                          
#  [78] "pad_mq_channels"                                                
#  [79] "splitPSM_mq"                                                    
#  [80] "pad_sm_channels"                                                
#  [81] "add_sm_pepseqmod"                                               
...
#  [90] "pad_psm_fields"                                                 
#  [91] "add_pepseqmod"                                                  
#  [92] "add_msgf_pepseqmod"                                             
#  [93] "check_dup_unimods"                                              
#  [94] "splitPSM_mz"                                                    
#  [95] "add_pep_retsd"                                                  
#  [96] "calc_pep_retsd"                                                 
#  [97] "add_n_pepexpz"                                                  
