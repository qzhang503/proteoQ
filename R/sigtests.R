...
#'   default column key is \code{Term} in `expt_smry.xlsx`: \cr \code{~ Term["A
#'   - C", "B - C"]}. \cr Additive random effects are indicated by \code{+
#'   (1|col_key_1) + (1|col_key_2)}... Currently only a syntax of single
