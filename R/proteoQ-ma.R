...
#' @importFrom magrittr %>%
#' @export
proteoMA <- function (id = gene, col_select = NULL, col_group = NULL, scale_log2r = FALSE, df = NULL, filepath = NULL, filename = NULL, ...) {
	id <- rlang::enexpr(id)
	...
	info_anal(id = !!id, col_select = !!col_select, col_group = !!col_group, scale_log2r = scale_log2r, impute_na = FALSE, df = df, filepath = filepath, filename = filename, anal_type = "MA")(...)
}
