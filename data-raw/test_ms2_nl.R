foo_test_ms2_nls <- function () {
   ...
   out2 <- calc_ms2ions(names(out), aa_masses_all[[1]], mod_indexes)
   ...
   # HQGVMNVGMGQKMNS 
   # 1660.70075 
   out2 <- calc_ms2ions(names(out), aa_masses_all[[2]], mod_indexes)
   ...
   out2 <- calc_ms2ions(names(out[1]), aa_masses_all[[1]], mod_indexes)
   ...
   out2 <- calc_ms2ions("HQGVMCNVGMGQKMNSC", aa_masses_all[[4]], mod_indexes)
   ...
   out2 <- calc_ms2ions(names(out[1]), aa_masses_all[[8]], mod_indexes)
   # HQGVMNVGMGQKSMNS HQGVMNVGMGQKSMNS HQGVMNVGMGQKSMNS HQGVMNVGMGQKSMNS 
   ...
   out2 <- calc_ms2ions(names(out[1]), aa_masses_all[[4]], mod_indexes)
   ...
   out2 <- calc_ms2ions(names(out[1]), aa_masses_all[[16]], mod_indexes)
